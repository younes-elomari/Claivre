...
const DeleteTiereAccountButton = ({
  tiereAccountId,
}: {
  ...
  const deleteGeneralAccount = async () => {
    try {
      setDeleting(true);
      await axios.delete("/api/tiereAccounts/" + tiereAccountId);
      router.refresh();
    } catch (error) {
      setDeleting(false);
      setError(true);
      ...
      <AlertDialog.Root>
        ...
        <AlertDialog.Content>
          ...
          <AlertDialog.Description>
            Are you sure you want to delete this Tiere Account and all its
            operations? This action cannot be undone.
          </AlertDialog.Description>
          <Flex mt="4" gap="3">
            <AlertDialog.Cancel>
...
export default DeleteTiereAccountButton;
